      ...
      <div className="guide-section scrollbar-hide">
        ...
        <div className="guide-card">
          ...
          <div className="demo-buttons-grid">
            {/* 신규 통합 페이지 단축 버튼 */}
            <button 
              className={`demo-nav-btn ${currentScreen === 'login' ? 'active' : ''} col-span-2 bg-blue-950/80 hover:bg-blue-900 border-blue-500/20`}
              onClick={() => setCurrentScreen('login')}
            >
              <span className="step-num">★</span>
              <span className="step-name font-bold text-blue-200">로그인 화면 (신설)</span>
            </button>
            <button 
              className={`demo-nav-btn ${currentScreen === 'cover' ? 'active' : ''} col-span-2 bg-purple-950/80 hover:bg-purple-900 border-purple-500/20`}
              onClick={() => setCurrentScreen('cover')}
            >
              <span className="step-num">★</span>
              <span className="step-name font-bold text-purple-200">통합 표지 (홈 화면)</span>
            </button>
            <button 
              className={`demo-nav-btn ${currentScreen === 'idrop' ? 'active' : ''} bg-teal-950/80 hover:bg-teal-900 border-teal-500/20`}
              onClick={() => setCurrentScreen('idrop')}
            >
              <span className="step-num">★</span>
              <span className="step-name font-bold text-teal-200">점안관리 (IDROPM)</span>
            </button>
            <button 
              className={`demo-nav-btn ${currentScreen === 'bio' ? 'active' : ''} bg-rose-950/80 hover:bg-rose-900 border-rose-500/20`}
              onClick={() => setCurrentScreen('bio')}
            >
              <span className="step-num">★</span>
              <span className="step-name font-bold text-rose-200">생체신호 페이지</span>
            </button>
            <button 
              className={`demo-nav-btn ${currentScreen === 'survey' ? 'active' : ''} bg-amber-950/80 hover:bg-amber-900 border-amber-500/20 col-span-2`}
              onClick={() => setCurrentScreen('survey')}
            >
              <span className="step-num">★</span>
              <span className="step-name font-bold text-amber-200 font-extrabold">문진표 페이지 (12문항)</span>
            </button>
